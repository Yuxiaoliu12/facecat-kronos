...
# Ensure facecat model is importable
...
class KronosScreener:
    ...
    def load_model(self):
        ...
        from facecat.model.kronos import KronosTokenizer, Kronos, KronosPredictor
    ...
    def predict_stock(
        ...
        # Timestamps
        from facecat.model.kronos import calc_time_stamps
        ...
        from facecat.model.kronos import auto_regressive_inference
